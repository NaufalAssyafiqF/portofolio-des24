  ...
  return (
    <Link href={project.link}>
      <motion.div
        ...
        initial="hidden"
        whileInView={"visible"}
        className="w-[380px] min-h-96 max-h-[400px] rounded-2xl shadow-xl border-2 border-gray-300 overflow-hidden group hover:scale-105 transition-all duration-500 cursor-pointer"
      >
