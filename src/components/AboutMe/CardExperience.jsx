...
const CardExperience = ({title, place, date}) => {
  return (
    <div className="md:w-1/2 sm:w-[95%] w-[95%] flex md:justify-center sm:justify-end justify-end text-right md:pr-8 sm:pr-0 pr-0 mt-8 mb-8 hover:scale-105 transition-all duration-500">
      <div className="md:w-[85%] sm:w-[90%] w-[90%] text-left bg-white p-4 rounded-lg shadow-md">
        <h2 className="md:text-lg sm:text-base text-base font-semibold mb-4">{title}</h2>
